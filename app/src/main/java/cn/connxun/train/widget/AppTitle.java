package cn.connxun.train.widget;
...
import cn.connxun.train.utils.util.ConvertUtils;
import cn.connxun.train.utils.util.ResourceUtils;
...
public class AppTitle extends RelativeLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        ...
        if (appBarBtn1.isShown() || appBarBtn2.isShown()) {
            appBarTitle.setMaxWidth(ConvertUtils.dp2px(context, 120));
        } else if (appBarBtn1.isShown() && appBarBtn2.isShown()) {
            appBarTitle.setMaxWidth(ConvertUtils.dp2px(context, 150));
        } else {
            appBarTitle.setMaxWidth(ConvertUtils.dp2px(context, 200));
        }
