...
public class ClassTypeAdapter  extends RecyclerArrayAdapter<CType> {
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new ClassTypeAdapter.ViewHolder(parent);
    }

    class ViewHolder extends BaseViewHolder<CType> {
        ...
        public void setData(CType data) {
            super.setData(data);
            tvItemClassTitle.setText(data.getTypename());
